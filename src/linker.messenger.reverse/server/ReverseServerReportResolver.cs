...
namespace linker.messenger.reverse.server
{
    ...
    /// 穿透节点报告处理器
    /// </summary>
    public class ReverseServerReportResolver : IResolver
    {
        public byte Type => (byte)ResolverType.ReverseReport;

        private readonly IMessengerResolver messengerResolver;

        public ReverseServerReportResolver(IMessengerResolver messengerResolver)
        {
