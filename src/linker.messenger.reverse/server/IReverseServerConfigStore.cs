...
{
    public interface IReverseNodeStore : INodeStore<ReverseServerNodeStoreInfo, ReverseServerNodeReportInfo>
    {
    }
    public interface IReverseNodeConfigStore : INodeConfigStore<ReverseServerConfigInfo>
    {

    }
    public class ReverseServerNodeInfo
    {
    ...
    public sealed class ReverseServerConfigInfo : ReverseServerNodeInfo, INodeConfigBase
    {
    ...
    public class ReverseServerNodeReportInfo : ReverseServerNodeInfo, INodeReportBase
    {
    ...
    public sealed class ReverseServerNodeStoreInfo : ReverseServerNodeReportInfo, INodeStoreBase
    {
    ...
    public partial class ReverseServerNodeReportInfoOld
    {
