<template>
   <el-table border style="width: 100%" height="32px" size="small" @sort-change="handleSortChange" class="table-sort">
        <el-table-column prop="MachineId" :label="$t('home.device')" width="100" sortable="custom" ></el-table-column>
        <el-table-column prop="Version" :label="$t('home.version')" width="100" sortable="custom"></el-table-column>
