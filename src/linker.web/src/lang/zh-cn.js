export default {
    ...
    'wakeup.typeWol':'🎩魔术包',
    'wakeup.type1':'🎩魔术包',
    'wakeup.typeSwitch':'🚨继电器',
    'wakeup.type2':'🚨继电器',
    'wakeup.name':'名称',
    'wakeup.value':'值',
    'wakeup.valueMac':'MAC地址',
    'wakeup.valueCom':'COM端口',
    'wakeup.valueComText':'波特率9600，数据位长度8，奇偶校验无，停止位1，',
    'wakeup.contentOpen':'连通包',
    'wakeup.contentOpenText':'例如 : 0xA0,0x01,0x01,0xA2',
    'wakeup.contentClose':'断开包',
    'wakeup.contentCloseText':'例如 : 0xA0,0x01,0x00,0xA1',
    'wakeup.content':'内容',
    'wakeup.remark':'备注',
    'wakeup.del': '删除',
    'wakeup.edit': '修改',
