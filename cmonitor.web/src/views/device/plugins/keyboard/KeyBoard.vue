...
export default {
    ...
    setup() {
        ...
        const state = reactive({
            name: computed(() => pluginState.value.keyboard.devices.length > 0 ? pluginState.value.keyboard.devices[0].MachineName : 'unknow'),
            names: computed(() => pluginState.value.keyboard.devices.map(c => c.MachineName)),
            list: [
                [
                    { text: '1', key: 49 }, { text: '2', key: 50 }, { text: '3', key: 51 }, { text: '4', key: 52 }, { text: '5', key: 53 }
                ],
                [
                    { text: '6', key: 54 }, { text: '7', key: 55 }, { text: '8', key: 56 }, { text: '9', key: 57 }, { text: '0', key: 48 }
                ],
                [
        ...
        const handleClose = () => {
            pluginState.value.keyboard.showKeyBoard = false;
        }
