...
namespace cmonitor.config
{
    ...
    public sealed class ConfigWrapInfo
    {
        public Dictionary<string, Dictionary<string, object>> Config = new Dictionary<string, Dictionary<string, object>>();
    }
