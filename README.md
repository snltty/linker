...
###### 系统
01. 桌面捕获，**win api**
02. 系统信息，展示CPU，内存利用率，硬盘使用率 **win api**
03. 发呆时间，展示系统无操作时间 **win api**
04. 音量控制，音量和静音 **c++ core audio api**
05. 音频峰值，展示音频峰值，是否在播放音视频，及激昂程度
06. 系统亮度，暂不支持外界显示器 **WMI**
###### 程序
07. 程序限制，分为禁止打开程序，和自定检测关闭程序 **regedit**
08. 前景窗口，当前焦点程序捕获，手动关闭之 **win api**
09. 时间统计，查看程序使用时间记录
###### 网络
10. 网络限制，程序，域名，IP 黑白名单
11. 网速显示，由网络限制组件提供
###### 命令
12. 消息提醒，向设备发送消息提醒
13. 发送命令，开机(shutdown -s -f -t 00)，关机(shutdown -r -f -t 00)，等等
###### 其它
14. U 盘限制，禁用或启用U盘 **regedit**
15. 壁纸程序，为所有设备设置统一壁纸，以程序的方式
16. 键盘按键，显示键盘按键(当前键盘按键由壁纸程序提供) **win api**
17. 锁屏程序，打开锁屏程序，禁用键盘
18. 设备用户，显示当前使用设备用户姓名(请自定义向**内存共享**提供)
