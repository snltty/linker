<template>
    <div>
        <ul class="list">
            ...
            <template v-else>
                <li><a href="javascript:;" @click="state.show = true">暂无配置</a></li>
            </template>

        </ul>
        <el-dialog v-model="state.show" @open="handleOnShowList" append-to=".app-wrap"
            :title="`端口转发到【${state.machineName}】`" top="1vh" width="600">
            <div>
                <div class="t-c head">
